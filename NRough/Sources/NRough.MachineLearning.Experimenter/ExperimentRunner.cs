...
{
    public class ExperimentRunner : IDisposable
    {
        #region Globals

        private IExperimentRunnable testObject = null;
        ...
        private object[] lastParameterVector = null;
        private object[] lastSavedParameterVector = null;
        ...
        public ExperimentRunner(string resultFileName, IExperimentRunnable testObject, string autoSaveFileName, int autoSaveTime)
        {
        ...
        public ExperimentRunner(string testName, IExperimentRunnable testObject, string autoSaveFileName)
            : this(testName, testObject, autoSaveFileName, 60 * 1000)
        {
        }

        public ExperimentRunner(string testName, IExperimentRunnable testObject)
        ...
        public object[] LastSavedParameterVector
        {
            get { return this.lastSavedParameterVector; }
        }

        public object[] CurrentParameterVector
        {
            get { return (object[])testObject.Current; }
        }

        public IExperimentRunnable TestObject
        {
        ...
        public bool RunSingleTest()
        {
            ...
            lock (syncRoot)
            {
                if (testObject.MoveNext())
                {
                    ...
                    object[] parameterVector = (object[])testObject.Current;
                    ...
                    */
                    ...
                    this.lastParameterVector = (object[]) this.testObject.Current;
        ...
        public bool RestoreState(String fileName)
        {
            ...
            try
            {
                ...
                using (FileStream stream = new FileStream(fileName, FileMode.Open))
                {
                    ...
                    testObject = (IExperimentRunnable)formatter.Deserialize(stream);
                    lastSavedParameterVector = (object[])testObject.Current;
                    stream.Close();

...
namespace Infovision.MRI
{
	public class MRIMaskConcentricImageFilter
	{
		...
		public MRIMaskConcentricImageFilter()
		{
			...
			this.KernelType = BinaryErodeImageFilter.KernelType.Cross;
		}
		...
		public IImage Execute(IImage image)
		{
            ...
            extractImage.SetDirectionCollapseToStrategy(ExtractImageFilter.DirectionCollapseStrategyType.DIRECTIONCOLLAPSETOSUBMATRIX);
            ...
            for (int z = 0; z < depth; z++)
			{
                ...
                outerMask = (isImage3D == true)
                      ? extractImage.Execute(imageITK.ItkImage, sliceSize, sliceIndex, ExtractImageFilter.DirectionCollapseStrategyType.DIRECTIONCOLLAPSETOSUBMATRIX)

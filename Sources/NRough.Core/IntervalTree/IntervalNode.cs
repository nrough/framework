...
namespace NRough.Core.IntervalTree
{
  ...
  public class IntervalNode<T, D> where D : struct, IComparable<D>
  {
        ...
        private SortedDictionary<Interval<T, D>, List<Interval<T, D>>> intervals;
        private D center;
        ...
        public IntervalNode()
        {
            ...
            intervals = new SortedDictionary<Interval<T, D>, List<Interval<T, D>>>();
            center = default(D);
            leftNode = null;
            rightNode = null;
        }
    ...
    public IntervalNode<T,D> Right {
      ...
      set { rightNode = value; }
        ...
        private Nullable<D> GetMedian(SortedSet<D> set)
        {
            int i = 0;
